...
export const HeroSection = () => {
  return (
    <div className="mx-auto flex flex-col lg:flex-row gap-6 lg:gap-10 max-w-[95%] lg:max-w-[1600px] justify-between px-4 lg:px-8 -z-1">
      {/* Left Section */}
      ...
      <div className="grid grid-cols-3 gap-2 sm:gap-4 lg:gap-6 mt-4 lg:mt-0 lg:w-2/3 h-full">
        {/* Employer Card */}
        <div className="space-y-2 sm:space-y-4 md:space-y-10 group flex flex-col min-h-full">
          <div className="relative overflow-hidden rounded-[10px] rounded-br-[50px] sm:rounded-br-[75px] lg:rounded-br-[100px] bg-[#FADADA] h-[180px] sm:h-[200px] md:h-[240px] lg:h-[280px] xl:h-[340px]">
            <Image
        ...
        {/* Interviewer Card */}
        <div className="space-y-2 sm:space-y-4 md:space-y-10 group flex flex-col min-h-full">
          <div className="relative overflow-hidden rounded-bl-[30px] sm:rounded-bl-[45px] lg:rounded-bl-[60px] rounded-[10px] bg-[#CAFA63] card-noise with-vector2 hover:cursor-pointer flex-grow group card-hover h-[120px] sm:h-[140px] md:h-[160px] lg:h-[180px] xl:h-[220px]">
          ...
          <div className="relative overflow-hidden rounded-tl-[30px] sm:rounded-tl-[45px] lg:rounded-tl-[60px] rounded-[10px] bg-[#EDFEC6] h-[180px] sm:h-[200px] md:h-[240px] lg:h-[280px] xl:h-[340px]">
            <Image
        ...
        {/* Candidate Card */}
        <div className="space-y-2 sm:space-y-4 md:space-y-10 group flex flex-col min-h-full">
          <div className="relative overflow-hidden rounded-tr-[50px] sm:rounded-tr-[75px] lg:rounded-tr-[100px] rounded-[10px] bg-[#E3DCFF] h-[180px] sm:h-[200px] md:h-[240px] lg:h-[280px] xl:h-[340px]">
            <Image
