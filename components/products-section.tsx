...
const ProductCard = ({
  ...
  return (
    <Card className="relative bg-white p-4 rounded-[35px] shadow-sm flex flex-col items-center overflow-hidden">
      <div
      ...
      <div className="flex flex-col items-center mt-2 relative z-20 flex-grow">
        ...
        <div className="flex flex-col justify-center items-center mt-2 flex-grow">
      ...
      <div className="flex gap-4 mt-2 justify-center pb-2">
        <button className="bg-black text-white font-Onest text-sm px-6 py-2 rounded-[65px] transition-all duration-300 ease-in-out hover:shadow-[0px_2px_0px_rgba(0,0,0,0.3)]">
          {buttonText1}
        </button>
        
        <button className="border border-[#565656] border-b-2 text-[#565656] font-Onest text-sm px-6 py-2 rounded-[65px] transition-all duration-300 ease-in-out hover:shadow-[0px_2px_0px_rgba(0,0,0,0.3)]">
          {buttonText2}
        </button>
      </div>
    </Card>
...
const ProductsSection = () => {
  return (
    <div className="my-20 bg-[#FFFFFF] rounded-3xl border p-8 max-h-1/3 self-center">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mx-auto max-w-[80%] my-12">
        <ProductCard
