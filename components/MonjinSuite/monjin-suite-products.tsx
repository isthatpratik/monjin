  ...
  return (
    <div className="relative mx-auto rounded-[32px] flex flex-col lg:flex-row justify-between bg-[url('/assets/MonjinSuite/monjin-suite-products-bg.png')] bg-cover bg-center my-10">
      ...
      <div className="lg:w-1/2 flex flex-col items-center lg:items-start lg:justify-evenly justify-center text-center lg:text-left px-6 lg:px-10 py-8">
        ...
        <div>
          <Button className="bg-[#ffffff] text-black rounded-full w-64 h-16 hidden lg:block md:block font-Onest font-normal text-xl py-2 hover:bg-gray-200 hover:shadow-monjin transition-all duration-300 ease-in-out">
            Start Trial
          </Button>
        </div>
      </div>
      ...
      {isMobile ? (
        <div className="w-4/5 mx-auto">
          ...
          <div className="mt-8 pb-8">
            <Button className="bg-[#ffffff] text-black rounded-full w-full py-2 hover:bg-gray-200 hover:shadow-monjin transition-all duration-300 ease-in-out">
              Start Trial
            </Button>
          </div>
        </div>
