        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-10">
            <div className="flex items-start gap-4">
              <div className="w-16 h-16 flex items-center justify-center rounded-2xl bg-[#E5FFCF] shadow-[0px_22px_28px_rgba(214,222,189,0.45)]">
              ...
              <div>
                ...
                <h3 className="text-2xl font-medium">+91 – 88888 17031</h3>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-10 shadow-[0_4px_20px_rgba(0,0,0,0.05)]">
            <div className="flex items-start gap-4">
              <div className="w-16 h-16 flex items-center justify-center rounded-2xl bg-[#E8E5FF] shadow-[0px_22px_28px_rgba(200,189,222,0.45)]">
                <Mail className="w-6 h-6 text-[#7B6EF6]" />
              </div>
              <div>
                <span className="inline-block px-4 py-1 bg-gray-100 rounded-full text-sm mb-2">MAIL</span>
                <h3 className="text-2xl font-medium">info@monjin.com</h3>
              </div>
            </div>
          </div>
        </div>
