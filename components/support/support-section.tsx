...
const faqs = [
  ...
  },
  {
    ...
    answer: "Check your system audio settings and ensure your headphones are selected as the output device.",
  },
  {
  ...
  },
  {
    ...
    answer: "Ensure your camera permissions are enabled and no other application is using your camera.",
  },
  {
  ...
  },
  {
    ...
    answer: "Yes, interviews can be conducted on mobile devices or tablets with good internet connectivity.",
  },
  {
    question: "When can I give the interview?",
    answer: "Interview slots are flexible and can be scheduled according to your availability.",
  },
  {
    question: "What is the Green Room?",
    answer: "The Green Room is a pre-interview space where you can test your audio and video settings.",
  },
  {
    question: "What happens after the interview is completed?",
    answer: "After the interview, your responses will be evaluated and you'll receive feedback through our platform.",
  },
  {
    question: "When will I get feedback?",
    answer: "Feedback timing varies but typically you'll receive it within 48-72 hours after the interview.",
  },
]
