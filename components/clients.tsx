...
export function Clients() {
  return (
    <div className="mt-20 bg-[#FFFFFF] rounded-3xl p-12">
      <div className="flex flex-col md:flex-row justify-between items-center">
        <div className="max-w-xl md:w-1/2">
          ...
          <h2 className="text-4xl font-Onest font-medium text-[#262628] mb-4">
            Enabling Global Leaders to Build Exceptional Teams
          </h2>
          <p className="text-sm text-[#0D0E11] mb-8 font-figtree font-regular max-w-[20vw] mt-4">
