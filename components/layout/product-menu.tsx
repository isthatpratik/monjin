    ...
    <div className="relative group">
      ...
      >
        <div className="relative flex h-14 w-14 shrink-0 items-center justify-center rounded-xl bg-white shadow-sm">
          <Image src={item.imageURL} alt={item.title} width={40} height={40} className="rounded-lg" />
        </div>
      ...
      {/* Triangle pointer */}
      <div className="absolute -top-2 left-1/2 w-4 h-4 rotate-45 bg-white border-t border-l border-gray-200 z-10 group-hover:block hidden" />
    </div>
  );
}
...
export default function ProductMenu() {
  return (
    <div className="relative">
      {/* Triangle pointer */}
      <div className="absolute -top-2 left-1/2 w-4 h-4 rotate-45 bg-white border-t border-l border-gray-200 z-10" />

      {/* Main dropdown content */}
      <div className="relative bg-white rounded-3xl shadow-lg border border-gray-200 p-8 w-[1000px] mt-2">
