...
const FeatureSection = () => {
  return (
    <div className="flex flex-col mt-20 z-50 items-center justify-center">
      ...
      <div className="flex flex-col gap-4 items-center mt-10 py-6">
        <h2 className="font-Onest font-medium text-[#1D1E23] md:text-6xl text-center tracking-tighter text-4xl md:max-w-full max-w-[80%] leading-relaxed">
          Powering Achievements with <br /> Transformative Tools
        </h2>
        <p className="font-figtree font-normal text-[#1D1E23] tracking-tight text-center md:max-w-full max-w-[80%] sm:text-sm md:text-base">
          Unleash the true power of your processes with solutions built for rapid execution, <br /> flawless precision, and transformative results
        </p>
      </div>

      {/* Three Divs Section with Responsive Layout */}
      <div className="flex flex-col sm:flex-row justify-between gap-8 mt-6 w-full sm:w-[90%]">
        {/* Div 1 */}
